...
const BannerTop = () => {
  return (
    <div className="flex flex-ro justify-between mx-auto max-w-screen-2xl p-1 shadow-lg border-b border-b-1 border-gray-300 bg-white">
      <div className="flex flex-row gap-2 items-center">
        ...
        <a href="https://www.instagram.com/italianolaplata/" className="opacity-60 hover:opacity-100" target="blank">
          <InstagramLogo />
        </a>
      </div>
      <div className="flex gap-3">
        ...
        <a href="https://portal.italianolaplata.org.ar/Cuenta/Login" target="blank">
