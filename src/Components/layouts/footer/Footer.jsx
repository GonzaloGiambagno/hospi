      ...
      <div className="mx-auto w-full max-w-screen-2xl mt-5 rounded-t-2xl">
        <div className="flex justify-center">
          ...
          >
            <div className="flex flex-wrap justify-around w-10/12 flex-col gap-2 md:flex-row">
              <ContactoItem icon={<BsFillPinMapFill size={22} />} text="Av. 51 Nº 1725 e/ 29 y 30" />
              <ContactoItem icon={<BsFillTelephoneFill size={22} />} text="+54 221 512 9500" />
              <ContactoItem icon={<HiOutlineMail size={24} />} text="info@italianolaplata.org.ar" />
            </div>
          </CardHeader>
        </div>
        <div className="grid grid-cols-1 justify-between p-4 pt-16 mt-2 items-center md:grid-cols-2 content-center border-t border-blue-gray-100">
          ...
          <div className="grid mt-4 md:mt-0 sm:grid-cols-2 justify-center md:justify-between  md:gap-4">
            <ul>
              <Typography variant="small" color="blue-gray" className="mb-2 font-medium opacity-40">
                Accesos Rápidos
              </Typography>
        ...
        <div className="mt-8 flex w-full flex-col items-center justify-center border-t border-blue-gray-100 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="">Hospital Italiano La Plata</a>. All Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <SocialLink icon={<SocialIconFacebook />} href="https://www.facebook.com/italianolaplata" />
            <SocialLink icon={<SocialIconTwitter />} href="https://twitter.com/i/flow/login?redirect_after_login=%2Fitalianolaplata"/>
            <SocialLink icon={<SocialIconInstagram />} href="https://www.instagram.com/italianolaplata/"/>
          </div>
        </div>
      </div>
    </div>
